...
from benchmark_remat_utils import profile_scripted_graph, profile_fused_graph
...
def benchmark_on_small_examples():
    random.seed(1)
    print("name, scripted_cuda_time, fused_cuda_time, remat_cuda_time, num_fusion_group", flush=True)
