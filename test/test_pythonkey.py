...
from functorch import (
    ...
    partition_with_recompute_fwd_in_bwd, default_partition
)
...
class TestPartitioning(TestCase):
    def test_recompute_partitioning(self):
        ...
        for partition_fn in [default_partition, partition_with_recompute_fwd_in_bwd]:
            ...
            compiled_fn = compiled_function(fn, compile_fn, compile_fn, partition_fn)
